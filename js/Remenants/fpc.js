...
function focusPlusContext(data) {
     ...
     */
     var brush = d3.brushX().extent([[0,0], [width, height2]]).on("start brush end",brushed);
    ...
    */
    ...
    //here..
    focus.append("g")
      .attr("class", "axis axis--y").call(yAxis)
    //here..
    ...
    selected_dots = dots.selectAll("dot")
        //here..
        .data(data.features).enter().append("circle").attr("class", "dot").style("opacity", 1.0)
        .filter(function (d) { return d.properties.EQ_PRIMARY != null })
        .attr("cx", function (d) {
    ...
    context.append("g")
      .attr("class", "brush").call(brush).call(brush.move, xScale.range());
